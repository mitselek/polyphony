	...
	<main class="mx-auto max-w-5xl px-6 pb-16">
		...
		<section class="mb-16 rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-100">
			...
			<p class="mb-4 text-slate-600 leading-relaxed">
				Polyphony is a <strong>federated platform</strong> that helps choirs manage their music libraries, 
				organize rehearsals, and share scores securely within <strong>private circles</strong>.
			</p>
		...
		<div class="grid gap-6 sm:grid-cols-2">
			<!-- Find a Choir -->
			<a href="/directory" class="group rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-100 transition hover:shadow-md hover:ring-indigo-200">
				<div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-100 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition">
