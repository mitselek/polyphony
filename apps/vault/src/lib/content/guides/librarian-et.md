# Raamatukoguhoidja teejuht

_Juhend noodikogu haldamiseks ja korrashoiuks_

---

## Sissejuhatus

Raamatukoguhoidja ehk **Librarian** on võtmeisik, kes vastutab selle eest, et kooril oleks noodid alati kättesaadavad ja korras. Sinu ülesanne on digitaalse noodikogu täiendamine ja haldamine.

---

## Sinu õigused

Raamatukoguhoidjana on sul järgmised erivõimekused:

- **Nootide lisamine:** Saad laadida üles uusi teoseid ja seadeid (PDF faile).
- **Info muutmine:** Saad parandada teoste pealkirju, autorite nimesid ja muud metaandmeid.
- **Kustutamine:** Saad eemaldada vigaseid faile või topelt teoseid.
- **Kõik laulja õigused:** Loomulikult saad ka ise noote vaadata ja alla laadida.

⚠️ **Mida sa teha ei saa:**

- Sa ei saa kutsuda uusi liikmeid ega muuta nende rolle (see on Admini töö).
- Sa ei saa hallata proovide kalendrit (see on Dirigendi töö).
...
3. Sisesta teose põhiandmed:
   ...
   - **Helilooja (Composer):** Autorite nimed.

### …lisada noodifaili (Edition)?
